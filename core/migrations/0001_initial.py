    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(help_text=b'Must be an accurate timezone name, eg. "America/Los_Angeles"', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.IntegerField(help_text=b'Uses the default rate unless otherwise specified.', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared', models.BooleanField(default=False, verbose_name=b'Is this room a hostel/shared accommodation?')),
                ...
                ('residents', models.ManyToManyField(related_name='residents', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_by', to=settings.AUTH_USER_MODEL, null=True)),
